...
}else if($decoupageUrl[2] == "www.youtube.com"){
...
}else if($decoupageUrl[2] == "www.metacafe.com"){
...
}else if($decoupageUrl[2] == "videos.arte.tv"){
...
}else if($decoupageUrl[2] == "www.vimeo.com"){
...
}else if($decoupageUrl[2] == "www.allocine.fr"){
...
}else if($decoupageUrl[2] == "www.uvioo.com"){
