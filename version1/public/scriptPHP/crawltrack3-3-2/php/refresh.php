...
if ($checklink == 1) {
	$urlrefresh = "../../../index.php?page=statistiques&navig=$navig&period=$period&site=$site&crawler=$crawlencode&graphpos=$graphpos&checklink=$checklink#top";
} else {
	$urlrefresh = "../../../index.php?page=statistiques&navig=$navig&period=$period&site=$site&crawler=$crawlencode&graphpos=$graphpos&checklink=$checklink";
}
