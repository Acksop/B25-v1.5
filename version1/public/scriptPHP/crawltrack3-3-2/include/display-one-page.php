...
if ($nbrresult >= 1) {
	...
	echo "<img src=\"".$pathFromRootToCrawltrackImages."/graphs/crawler-graph.php?graphname=$graphname&amp;crawltlang=$crawltlang\" alt=\"graph\"  width=\"450\" height=\"200\"/>\n";
	echo "</div>\n";
	echo "</div>\n";
	...
	if ($order == 3) {
		echo "<tr><th class='tableau1'>\n";
		echo "<form src=\"".$varPostFormIncludePageWithRedirection."\" method=\"POST\" >\n";
	...
	foreach ($sorttab as $page1 => $value) {
		if ($comptligne < 32 || $displayall == 'yes') {
			...
			if ($comptligne % 2 == 0) {
				echo "<tr><td class='tableau3'><a href='index.php?".$varGetIncludePageWithRedirection."navig=2&amp;period=" . $period . "&amp;site=" . $site . "&amp;crawler=" . $page1 . "&amp;graphpos=" . $graphpos . "'>" . $page1display . "</a></td>\n";
				...
				echo "<tr><td class='tableau30'><a href='index.php?".$varGetIncludePageWithRedirection."navig=2&amp;period=" . $period . "&amp;site=" . $site . "&amp;crawler=" . $page1 . "&amp;graphpos=" . $graphpos . "'>" . $page1display . "</a></td>\n";
