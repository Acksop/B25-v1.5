...
cadreAlignCentrerDebut();
	...
	if ($period != 5) {
		...
		echo "<img src=\"".$pathFromRootToCrawltrackImages."graphs/visit-graph.php?crawltlang=$crawltlang&period=$period&navig=$navig&graphname=$graphname\" USEMAP=\"#visit\" alt=\"graph\" width=\"700\" height=\"300\"  border=\"0\"/>\n";
		echo "</div>\n";
	...
	if ($nbrscript != 0) {
		...
		echo "<div class='alert'><img src=\"".$pathFromRootToCrawltrackImages."images/error.png\" width=\"16\" height=\"16\" border=\"0\" >" . $language['danger'] . " :</div><div class='scriptdisplay'>" . $totalscriptdisplay . "</div><br>\n";
		echo "</td></tr>\n";
		echo "</table></div>\n";
	}
	if ($nbrparameters != 0) {
		...
		echo "<table   cellpadding='0px' cellspacing='0' width='100%'>\n";
		echo "<tr><td class='tableau23'>\n";
		echo "<div class='alert'><img src=\"".$pathFromRootToCrawltrackImages."images/error.png\" width=\"16\" height=\"16\" border=\"0\" >" . $language['attack_sql'] . " :</div><div class='scriptdisplay'>" . $totalattackdisplay . "</div><br>\n";
		echo "</td></tr>\n";
		echo "</table></div>\n";
	}
		...
		if (($displayall == 'no' && $i < $rowdisplay) || $displayall == 'yes') {
			...
			foreach ($tableauip as $ip) {
				...
				if (isset($countrycode[$ip])) {
					$code = $countrycode[$ip];
					$ipdisplay.= "&nbsp;" . $ip . "&nbsp;<a href=\"http://www.whois-search.com/whois/" . $ip . "\" target=\"blank\"><span class=\"noprint\"><img src=\"".$pathFromRootToCrawltrackImages."images/report_user.png\" width=\"16\" height=\"16\" border=\"0\" ></a>&nbsp;</span><br>&nbsp;<img src=\"".$pathFromRootToCrawltrackImages."images/flags/$code.gif\" width=\"16px\" height=\"11px\"  border=\"0\" alt=\"$country[$code]\">&nbsp;&nbsp;$country[$code]<br>\n";
				} else {
					$ipdisplay.= "&nbsp;" . $ip . "&nbsp;<a href=\"http://www.whois-search.com/whois/" . $ip . "\" target=\"blank\"><span class=\"noprint\"><img src=\"".$pathFromRootToCrawltrackImages."images/report_user.png\" width=\"16\" height=\"16\" border=\"0\" ></a>&nbsp;</span><br>&nbsp;????<br>\n";
				}
			}
			...
			if ($comptligne % 2 == 0) {
				...
				echo "<td id='tableau5vsf' width='50%'><b><img src=\"".$pathFromRootToCrawltrackImages."images/error.png\" width=\"16\" height=\"16\" border=\"0\" >" . $language['danger'] . ": </b><br>" . $scriptdisplay . "<br><b>" . $language['attack_sql'] . ": </b><br>" . $attackdisplay . "<br><b>" . $language['bad_sql'] . ": </b><br>" . $badsitedisplay . "<br><b>" . $language['bad_url'] . ":</b><br><a href=\"#\">" . $urldisplay . "</a><br>&nbsp;</td></tr>\n";
			} else {
				...
				echo "<td id='tableau50vsf' width='50%'><b><img src=\"".$pathFromRootToCrawltrackImages."images/error.png\" width=\"16\" height=\"16\" border=\"0\" >" . $language['danger'] . ": </b><br>" . $scriptdisplay . "<br><b>" . $language['attack_sql'] . ": </b><br>" . $attackdisplay . "<br><b>" . $language['bad_sql'] . ": </b><br>" . $badsitedisplay . "<br><b>" . $language['bad_url'] . ":</b><br><a href=\"#\">" . $urldisplay . "</a><br>&nbsp;</td></tr>\n";
			}
			$comptligne++;
		}
	}
