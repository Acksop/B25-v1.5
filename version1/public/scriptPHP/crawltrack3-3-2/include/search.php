	...
	if ($search == 7) {
		...
		if (!$validaddress) {
			...
			if ($ipexplode[0] > 255 || $ipexplode[1] > 255 || $ipexplode[2] > 255 || $ipexplode[3] > 255) {
				...
				echo "<img src=\"".$pathFromRootToCrawltrackImages."images/flags/$code.gif\" width=\"16px\" height=\"11px\"  border=\"0\" alt=\"$country[$code]\">&nbsp;&nbsp;$country[$code]<br>\n";
				echo "</td></tr> \n";
				echo "</table></div><br>\n";
			...
			if ($search == 1) {
				...
				if (isset($list)) {
					...
					foreach ($list as $crawl) {
						...
						if ($comptdata < 100) {
							if ($comptligne % 2 == 0) {
								echo "<tr><td class='tableau5'><a href='index.php?".$varGetIncludePageWithRedirection."navig=2&amp;period=3&amp;site=" . $site . "&amp;crawler=" . $crawl . "'>" . $crawldisplay . "</a></td><tr>\n";
							} else {
								echo "<tr><td class='tableau50'><a href='index.php?".$varGetIncludePageWithRedirection."navig=2&amp;period=3&amp;site=" . $site . "&amp;crawler=" . $crawl . "'>" . $crawldisplay . "</a></td><tr>\n";
							}
						}
						$comptligne++;
						$comptdata++;
				...
				if (isset($list)) {
					...
					foreach ($list as $crawl) {
						...
						if ($comptdata < 100) {
							if ($comptligne % 2 == 0) {
								echo "<tr><td class='tableau5'><a href='index.php?".$varGetIncludePageWithRedirection."navig=4&amp;period=3&amp;site=" . $site . "&amp;crawler=" . $crawlencode . "'>" . $crawldisplay . "</a></td><tr>\n";
							} else {
								echo "<tr><td class='tableau50'><a href='index.php?".$varGetIncludePageWithRedirection."navig=4&amp;period=3&amp;site=" . $site . "&amp;crawler=" . $crawlencode . "'>" . $crawldisplay . "</a></td><tr>\n";
							}
						}
						$comptligne++;
						$comptdata++;
				...
				if (isset($list)) {
					...
					foreach ($list as $crawl) {
						...
						if ($comptdata < 100) {
							...
							if ($comptligne % 2 == 0) {
								echo "<tr><td class='tableau5'><a href='index.php?".$varGetIncludePageWithRedirection."validform=1&amp;search=4&amp;navig=5&amp;period=3&amp;site=" . $site . "&amp;crawler=" . $crawl2 . "'>" . $crawldisplay . "</a></td><tr>\n";
							} else {
								echo "<tr><td class='tableau50'><a href='index.php?".$varGetIncludePageWithRedirection."validform=1&amp;search=4&amp;navig=5&amp;period=3&amp;site=" . $site . "&amp;crawler=" . $crawl2 . "'>" . $crawldisplay . "</a></td><tr>\n";
							}
						}
						$comptligne++;
						$comptdata++;
				...
				if (isset($list)) {
					...
					foreach ($list as $crawl) {
						...
						if ($comptdata < 100) {
							$crawl2 = urlencode($crawl);
							if ($comptligne % 2 == 0) {
								echo "<tr><td class='tableau5'><a href='index.php?".$varGetIncludePageWithRedirection."validform=1&amp;search=6&amp;navig=5&amp;period=3&amp;site=" . $site . "&amp;crawler=" . $crawl2 . "'>" . $crawldisplay . "</a></td><tr>\n";
							} else {
								echo "<tr><td class='tableau50'><a href='index.php?".$varGetIncludePageWithRedirection."validform=1&amp;search=6&amp;navig=5&amp;period=3&amp;site=" . $site . "&amp;crawler=" . $crawl2 . "'>" . $crawldisplay . "</a></td><tr>\n";
							}
						}
						$comptligne++;
						$comptdata++;
				...
				echo "<h5>" . $language['crawler_name2'] . "&nbsp;&nbsp;<a href='index.php?".$varGetIncludePageWithRedirection."navig=2&amp;period=3&amp;site=" . $site . "&amp;crawler=$line2[0]'>" . $crawlernamedisplay . "</a></h5>";
