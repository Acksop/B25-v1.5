 ...
 */
 ...
 include_once dirname(__FILE__).'/functions_alternates.php';
...
function cache($cachename) {
	...
	global $pathFromSiteIndexToCrawltrackIndex;
	//echo "<h1>WOW</h1>".$crawlthost;
	$caching = false;
	if (file_exists($pathFromSiteIndexToCrawltrackIndex."cachecloseperiod/$cachename.gz")) {
			//Grab the cache:
			$fgz = @fopen($pathFromSiteIndexToCrawltrackIndex."cachecloseperiod/$cachename.gz", "r");
			$data = fread($fgz, filesize($pathFromSiteIndexToCrawltrackIndex."cachecloseperiod/$cachename.gz"));
			fclose($fgz);
	...
	if (file_exists($pathFromSiteIndexToCrawltrackIndex."cache/$cachename.txt") && ($time + 3600) > time() && $nocachetest != 1) {
		//Grab the cache:
		include ($pathFromSiteIndexToCrawltrackIndex."cache/$cachename.txt");
		echo "<div class='smalltextgrey'>" . $numbquery . " mysql query             " . getTime() . " s</div>";
		echo "</body>\n";
		echo "</html>\n";
		exit();
...
function close() {
	...
	if ($caching == 'true') {
		...
		if (($period >= 1000 || ($period >= 100 && $period < 200) || ($period >= 200 && $period < 300))&& $navig!=0 && $navig!=20 && $navig!=21  && $navig!=23 && $navig!=12 && $navig!=13 && $navig!=14 && $navig!=16) {
			$fp = fopen($pathFromSiteIndexToCrawltrackIndex."cachecloseperiod/$cachename.gz", 'w');
			fwrite($fp, gzcompress($data));
		} else {
			$fp = fopen($pathFromSiteIndexToCrawltrackIndex."cache/$cachename.txt", 'w');
			fwrite($fp, $data);
		}
		fclose($fp);
		echo "<br /><br /><br />";
...
function check_email($email) {
	// RegEx begin
	$nonascii = "\x80-\xff"; # Les caract\E8res Non-ASCII ne sont pas permis
...
function crawltbackforward($title, $period, $daytodaylocal, $monthtodaylocal, $yeartodaylocal, $daybeginlocal, $monthbeginlocal, $yearbeginlocal, $dayendweek, $monthendweek, $yearendweek, $crawler, $navig, $site, $graphpos) {
	...
	global $varGetIncludePageWithRedirection,$pathFromSiteIndexToCrawltrackIndex;
	...
	if ($navig == 0 || $navig == 6) {
		...
		$titledisplay = $language['keyword'] . ":<span> " . $title . "</span>";
	} elseif ($navig == 14) {
		$titledisplay = $language['entry-page'] . ":<span> " . $title . "</span>&nbsp;&nbsp;<a href='" . $hostsite . $crawler . "'><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/page.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"" . $language['entry-page'] . "\"></a>";
	} else {
	...
	if ($navig == 0) {
		...
		$firstline = "<br><div class='title'><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/" . $logodisplay . "\" width=\"16\" height=\"16\" border=\"0\" alt=\"" . $logodisplay . "\">&nbsp;" . $titledisplay . "</div>";
	} else {
		$firstline = "<div class='title'><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/" . $logodisplay . "\" width=\"16\" height=\"16\" border=\"0\" alt=\"" . $logodisplay . "\">&nbsp;" . $titledisplay . "</div>";
	}
	if ($period == 0 || $period >= 1000) {
		...
		if ($period == 0) {
			$value = "
            <h2>" . $language['display_period'] . "&nbsp;" .$language[$jour]."&nbsp;". $daytodaylocal . "/" . $monthtodaylocal . "/" . $yeartodaylocal . "          
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=1000&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_back_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"back\"></a>
            <img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_play.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"play\">
            <img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_end.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"end\"></h2>";
		} else {
			$periodback = $period + 1;
			$periodgo = $period - 1;
			if ($periodgo < 1000) {
			...
			$value = "
            <h2>" . $language['display_period'] . "&nbsp;" .$language[$jour]."&nbsp;". $daytodaylocal . "/" . $monthtodaylocal . "/" . $yeartodaylocal . "                
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=$periodback&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_back_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"back\"></a>
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=$periodgo&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_play_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"play\"></a>
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=0&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_end_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"end\"></a></h2>";
		}
	} elseif ($period == 2 || ($period >= 100 && $period < 200)) {
		$testdate = 0;
		if ($period == 2) {
			$value = "         
            <h2>" . $language['display_period'] . "&nbsp;" . $language[$monthtodaylocal] . "&nbsp;" . $yeartodaylocal . "            	
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=100&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_back_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"back\"></a>
            <img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_play.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"play\">
            <img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_end.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"end\"></h2>";
		} else {
			$periodback = $period + 1;
            ...
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=$periodback&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_back_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"back\"></a>
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=$periodgo&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_play_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"play\"></a>
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=2&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_end_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"end\"></a></h2>";
		}
	} elseif ($period == 3 || ($period >= 200 && $period < 300)) {
		$testdate = 0;
		if ($period == 3) {
			$value = "           
            <h2>" . $language['display_period'] . "&nbsp;" . $language['one_year'] . "&nbsp;" . $yeartodaylocal . "            	
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=200&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_back_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"back\"></a>
            <img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_play.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"play\">
            <img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_end.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"end\"></h2>";
		} else {
			$periodback = $period + 1;
            ...
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=$periodback&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_back_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"back\"></a>
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=$periodgo&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_play_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"play\"></a>
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=3&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_end_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"end\"></a></h2>";
		}
	} elseif ($period == 1 || ($period >= 300 && $period < 400)) {
		$testdate = 0;
		if ($period == 1) {
			$value = "            
            <h2>" . $language['display_period'] . "&nbsp;" . $language['days'] . "&nbsp;" . $language['from'] . "&nbsp;" . $daybeginlocal . "/" . $monthbeginlocal . "/" . $yearbeginlocal . "&nbsp;" . $language['to'] . "&nbsp;" . $dayendweek . "/" . $monthendweek . "/" . $yearendweek . "           	
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=300&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_back_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"back\"></a>
            <img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_play.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"play\">
            <img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_end.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"end\"></h2>";
		} else {
			$periodback = $period + 1;
            ...
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=$periodback&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_back_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"back\"></a>
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=$periodgo&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_play_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"play\"></a>
            <a href=\"index.php?".$varGetIncludePageWithRedirection."navig=$navig&amp;period=1&amp;site=$site&amp;crawler=$crawlencode&amp;graphpos=$graphpos\"><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/control_end_blue.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"end\"></a></h2>";
		}
