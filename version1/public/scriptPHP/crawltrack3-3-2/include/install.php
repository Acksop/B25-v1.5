	...
	<div class="form">
		<form action="index.php" method="POST">
			...
			<table class="centrer">
				...
				<tr>
				<td><B>Si besoin:</B> vous pouvez indiquez la variable (VARPAGE) utilis&eacute;e pour choisir la page d'acc&egrave;s sur un modele MVC (index.php?VARPAGE = NOMPAGE)</td>
				<td><input name="idpage" value="<?php echo $idpage; ?>" type="text" size="50"/></td>
				</tr>
				<tr>
				<td>variable NOMPAGE utilis&eacute; ( laissez les deux champs vide si vous installez crawltrack sans l'int&eacute;grer &agrave; un site MVC )</td>
				<td><input name="idnompage" value="<?php echo $idnompage; ?>" type="text" size="50"/></td>
				</tr>
				<tr>
				<td>chemin d'acces de l'index MVC au dossier Crawltrack ( exemple : scriptPHP/crawltrack3-3-2/ ) Attention respecter le slash &agrave; la fin et l'ommision du slash au debut ...</td>
				<td><input name="cheminCT" value="<?php echo $cheminCT; ?>" type="text" size="50"/></td>
				</tr>
				<tr>
				<td colspan="2">
				<br />
