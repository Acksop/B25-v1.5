...
include "scriptPHP/crawltrack3-3-2/include/listlang.php";

//language file include
if (in_array($crawltlang, $listlangcrawlt)) {
	include "scriptPHP/crawltrack3-3-2/language/" . $crawltlang . ".php";
}
...
foreach ($listsitecrawlt as $site) {
	...
	include ("scriptPHP/crawltrack3-3-2/include/cleaning-crawler-entry.php");
	
	//include visitors calculation file
	$connexion = $crawltconnexion;
	include ("scriptPHP/crawltrack3-3-2/include/visitors-calculation.php");
	if ($totalvisitor > 0) {
	...
	//send the mail
	require_once ("scriptPHP/crawltrack3-3-2/phpmailer/class.phpmailer.php");
	$mail = new PHPMailer();
	if ($crawltcharset != 1) {
...
//=================================================================================================================================
//Si vous voulez vider la base de donn\E9es chaque jour apr\E8s l'envoi du ou des Emails, changez la valeur de $crawltracklite \E0 1.
//Attention, avec la valeur par d\E9faut de $crawltracklitekeepday (0) seules les donn\E9es du jour et de la veille seront conserv\E9es;
// les donn\E9es plus anciennes seront perdues
//=================================================================================================================================
//=================================================================================================================================
...
//valeur par d\E9faut est 0, si vous voullez garder plus de donn\E9es, changez la valeur en mettant le nombre de jours que vous voullez garder.
