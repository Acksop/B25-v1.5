...
mysql_close($connexion);
	...
	echo "<br><table align='center' width='85%'>\n";
	echo "<tr><td align='left'>\n";
	echo "<h1>" . $language['data_suppress2'] . " :</h1>\n";
	echo "</td></tr><tr><td class='utilisateursInverse' style='text-align:left;'>\n";
	echo "<div class=\"form3\">\n";
	echo "<form action=\"index.php".$varPostFormIncludePageWithRedirection."\" method=\"POST\" >\n";
	echo "<input type=\"radio\" name=\"datatosuppress\" value=\"16\" >" . $language['attack_data'] . "<br></td></tr><tr><td class='utilisateurs' style='text-align:left;'>\n";
	echo "<input type=\"radio\" name=\"datatosuppress\" value=\"1\" >" . $language['other_bot'] . "<br></td></tr><tr><td class='utilisateursInverse' style='text-align:left;'>\n";
	...
	echo "<input type=\"radio\" name=\"datatosuppress\" value=\"8\">" . $language['one_month_data'] . "<br></td></tr><tr><td class='utilisateurs' style='text-align:left;'>\n";
	...
	echo "<input type=\"hidden\" name =\"suppressdata\" value=\"1\">\n";
	echo "<input type=\"hidden\" name =\"navig\" value=\"6\">\n";
	echo "<input type=\"hidden\" name =\"validform\" value=\"17\">\n</td></tr><tr><td class='utilisateursInverse' style='text-align:right;'>";
