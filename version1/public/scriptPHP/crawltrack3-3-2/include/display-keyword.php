	...
	foreach ($visitkeyword as $keyword => $value) {
		...
		if ($comptdata < $rowdisplay) {
			if ($comptligne % 2 == 0) {
				...
				echo "><a href='index.php?".$varGetIncludePageWithRedirection."navig=16&amp;period=" . $period . "&amp;site=" . $site . "&amp;crawler=" . $crawlencode . "&amp;graphpos=" . $graphpos . "' >" . $keyworddisplay . "</a></td>\n";
				echo "<td class='tableau6' width=\"8%\"" . crawltkeywordwindow($crawlencode) . ">\n";
				echo "<a href=\"#\">\n";
				echo " <img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/information.png\" width=\"16\" height=\"16\" border=\"0\" ></a>\n";
				echo "</td> \n";
