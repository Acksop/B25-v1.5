...
if (($nbrresult + $nbrattack404) >= 1) {
	...
	*/
	...
	if ($nbrparameters != 0) {
		...
		echo "<table   cellpadding='0px' cellspacing='0' width='100%'>\n";
		echo "<tr><td class='tableau23'>\n";
		echo "<div class='alert'><img src=\"".$pathFromRootToCrawltrackImages."images/error.png\" width=\"16\" height=\"16\" border=\"0\" >" . $language['attack'] . " :</div><div class='scriptdisplay'>" . $totalattackdisplay . "</div><br>\n";
		echo "</td></tr>\n";
		echo "</table></div>\n";
	}
		...
		if (($displayall == 'no' && $i < $rowdisplay) || $displayall == 'yes') {
			...
			if ($attackdisplay != "") {
				...
				if ($comptligne % 2 == 0) {
					...
					echo "<td id='tableau5vsf' width='50%'><b><img src=\"".$pathFromRootToCrawltrackImages."images/error.png\" width=\"16\" height=\"16\" border=\"0\" >" . $language['danger'] . ": </b><br>" . $scriptdisplay . "<br><b>" . $language['attack'] . ": </b><br>" . $attackdisplay . "<br><b>" . $language['bad_site'] . ": </b><br>" . $badsitedisplay . "<br><b>" . $language['bad_url'] . ":</b><br><a href=\"#\">" . $urldisplay . "</a><br>&nbsp;</td></tr>\n";
				} else {
					...
					echo "<td id='tableau50vsf' width='50%'><b><img src=\"".$pathFromRootToCrawltrackImages."images/error.png\" width=\"16\" height=\"16\" border=\"0\" >" . $language['danger'] . ": </b><br>" . $scriptdisplay . "<br><b>" . $language['attack'] . ": </b><br>" . $attackdisplay . "<br><b>" . $language['bad_site'] . ": </b><br>" . $badsitedisplay . "<br><b>" . $language['bad_url'] . ":</b><br><a href=\"#\">" . $urldisplay . "</a><br>&nbsp;</td></tr>\n";
				}
				$comptligne++;
			}
		}
