...
$code = "require_once(\"".$pathFromRootToCrawltrackImages."crawltrack.php\");";
	...
	foreach ($listsite as $site1) {
		...
		foreach ($logolist as $logochoice) {
			...
			if ($logochoice == 0) {
				...
				$lengthlogo = 80;
				$heigthlogo = 15;
				$alt = 'CrawlTrack: free and open-source crawlers and spiders tracking script- SEO -script open-source gratuit de d\E9tection des robots';
			} elseif ($logochoice == 7) {
				$logo = 'logo7.png';
				$lengthlogo = 80;
				$heigthlogo = 15;
			...
			echo "	<img src=\"".$pathFromRootToCrawltrackImages."images/$logo\" width=\"" . $lengthlogo . "px\" height=\"" . $heigthlogo . "px\" border=\"0\" alt=\"CrawlTrack\">";
			echo "<br><b>PHP:</b><br>\n";
