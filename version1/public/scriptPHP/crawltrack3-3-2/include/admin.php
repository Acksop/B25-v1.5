...
if ($_SESSION['rightadmin'] == 1) {
	switch($validform)
	{
		...
		default:
			...
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/page_white_php.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=16"><?php echo $language['see_tag'] ?></a></h5><br>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/tick.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=11"><?php echo $language['crawler_test_creation'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/cancel.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=12"><?php echo $language['crawler_test_suppress'] ?></a></h5><br>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/transmit_add.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=13"><?php echo $language['update_crawler'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/transmit_add.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=27"><?php echo $language['update_attack'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/database_add.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=31"><?php echo $language['goodsite_update'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/database_add.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=32"><?php echo $language['badreferer_update'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/database_add.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=33"><?php echo $language['goodreferer_update'] ?></a></h5><br>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/email.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=20"><?php echo $language['mail'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/clock.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=18"><?php echo $language['time_set_up'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/calendar_view_week.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=22"><?php echo $language['firstweekday-title'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/lock_open.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=21"><?php echo $language['public'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/language.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=25"><?php echo $language['choose_language'] ?></a></h5><br>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/user_edit.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=30"><?php echo $language['change_password'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/user_add.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=6"><?php echo $language['user_create'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/user_add.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=7"><?php echo $language['user_site_create'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/world_add.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=4"><?php echo $language['new_site'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/world_edit.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=23"><?php echo $language['modif_site'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/database_add.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=2"><?php echo $language['new_crawler'] ?></a></h5><br>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/user_delete.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=8"><?php echo $language['user_suppress'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/world_delete.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=9"><?php echo $language['site_suppress'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/database_delete.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=10"><?php echo $language['crawler_suppress'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/database_delete.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=19"><?php echo $language['ip_suppress'] ?></a></h5><br>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/database.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=26"><?php echo $language['admin_database'] ?></a></h5>
			<h5><img src="<?php echo $pathFromRootToCrawltrackImages; ?>images/compress.png" width="16" height="16" border="0" >&nbsp;&nbsp;<a href="./index.php?page=statistiques&navig=6&validform=17"><?php echo $language['data_suppress'] ?></a></h5><br>
