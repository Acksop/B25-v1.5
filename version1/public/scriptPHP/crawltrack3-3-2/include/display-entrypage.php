...
echo "<div style='position:relative;top:-20px;' width='100%' height:'5px' onmouseover=\"javascript:montre();\">&nbsp;</div>\n";
echo "<div class='tableaularge' align='center'>\n";
cadreDebut();
if (count($visitkeyword) >= 1) {
	echo "<table cellpadding='0px' cellspacing='0' width='100%'>\n";
	echo "<tr style='background-color:grey;'><th class='tableau1' colspan=\"2\" rowspan=\"2\">\n";
	...
	foreach ($visitkeyword as $keyword => $value) {
		...
		if ($comptdata < $rowdisplay && $i>0) {
			if ($comptligne % 2 == 0) {
				echo "<tr style='background-color:white;'><td class='tableau3g'";
				if ($keywordcut == 1) {
				...
				echo "<a href='" . $urlpage . "'><img src=\"".$pathFromSiteIndexToCrawltrackIndex."images/page.png\" width=\"16\" height=\"16\" border=\"0\" ></a>\n";
				echo "</td> \n";
