...
if ($nbrresult1 >= 1) {
	...
	if ($testip) {
		...
		echo "<img src=\"".$pathFromRootToCrawltrackImages."graphs/origine-graph.php?graphname=$graphname&amp;crawltlang=$crawltlang\" alt=\"graph\"  width=\"450px\" height=\"200px\"/>\n";
		echo "</div>\n";
		...
		foreach ($listcrawler as $crawl) {
			...
			if ($comptligne % 2 == 0) {
				echo "<tr><td class='tableau3h'><a href='index.php?".$varGetIncludePageWithRedirection."navig=2&amp;period=" . $period . "&amp;site=" . $site . "&amp;crawler=" . $crawl . "&amp;graphpos=" . $graphpos . "'>" . $crawldisplay . "</a></td>\n";
				...
				foreach (${'ipcrawler' . $crawl} as $ip) {
					...
					if ($teststrangeip) {
						echo "&nbsp;&nbsp;&nbsp;<span class='red'>$ip&nbsp;<a href='index.php?".$varGetIncludePageWithRedirection."navig=6&amp;iptosuppress=" . $ip . "&amp;period=" . $period . "&amp;site=" . $site . "&amp;validform=19&amp;suppressip=1&amp;graphpos=" . $graphpos . "'>???</a></span><br>\n";
					} else {
						echo "&nbsp;&nbsp;&nbsp;$ip<br>\n";
					}
				}
				...
				echo "<tr><td class='tableau30h'><a href='index.php?".$varGetIncludePageWithRedirection."navig=2&amp;period=" . $period . "&amp;site=" . $site . "&amp;crawler=" . $crawl . "&amp;graphpos=" . $graphpos . "'>" . $crawldisplay . "</a></td>\n";
