...
?>
		...
		<h2><form action="index.php<?php echo $varPostFormIncludePageWithRedirection;?>" method="POST" >
		...
		<form action="index.php<?php echo $varPostFormIncludePageWithRedirection;?>" method="POST" >
		<input type="hidden" name="navig" value="6">
