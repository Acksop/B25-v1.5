...
?>
	...
	document.write("<h2><a href='index.php?".$varGetIncludePageWithRedirection."decal=" + diffh + "&amp;navig=6&amp;validform=18&amp;validlogin=1'><?php echo $language['yes']; ?></a>&nbsp;&nbsp;&nbsp;<a href='index.php?".$varGetIncludePageWithRedirection."navig=6'><?php echo $language['no']; ?></a></h2><br><br>");
	<?php
	} else {
	?>
	document.write("<h5><?php echo $language['time_local']; ?></h5>");
	document.write("<h2><a href='index.php?".$varGetIncludePageWithRedirection."decal=" + diffh + "&amp;navig=6&amp;validform=18&amp;validlogin=2'><?php echo $language['yes']; ?></a>&nbsp;&nbsp;&nbsp;<a href='index.php?".$varGetIncludePageWithRedirection."navig=6'><?php echo $language['no']; ?></a></h2><br><br>");
	<?php
	}
?>
	</script>
