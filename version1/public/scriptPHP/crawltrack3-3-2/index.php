...
if ($navig == 0 || $navig == 1 || $navig == 2 || $navig == 3 || $navig == 4 || $navig == 8 || $navig == 11 || $navig == 12 || $navig == 13 || $navig == 14 || $navig == 16 || $navig == 17 || $navig == 18 || $navig == 19 || $navig == 20 || $navig == 21 || $navig == 22 || $navig == 23) {
	...
	close();
	if($varGetIncludePageWithRedirection != '' ){
	if( $navig != 1 && $navig != 3 && $navig != 2 && $navig != 8 && $navig != 11 ) echo "</div>";
	}
} else {
	echo "<br /><br /><br />";
	cadreAlignCentrerDebut();
	...
	$comparation_memory_text = conversionEtOrdonancementMemoire($memory_start,$memory_end,memory_peak_start,$memory_peak_end);
	$comparation_memory_html = surchargeHTML_testMemoire($camparation_memmory_text);
	echo $comparation_memory_html; 
	cadreAlignCentrerFin();
	if( $navig == 6 && $varGetIncludePageWithRedirection != '' ) echo "</div>";
}
...
$comparation_memory_text = conversionEtOrdonancementMemoire($memory_start,$memory_end,$memory_peak_start,$memory_peak_end);
cadreDebut(5);
$comparation_memory_html = surchargeHTML_testMemoire($comparation_memory_text);
echo $comparation_memory_html;
cadreFin(5);
