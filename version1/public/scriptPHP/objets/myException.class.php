...
class myException Extends Exception {
	...
	/* Oublions les getters et les setters c'est plus class de dire accesseurs et composeurs (ou d'autres mots aussi gros ceux là-s )
