<?php
function AfficheFormCorrectionArticle(){
	//--
	check_session();
	//--
	...
	echo "<form method='get' action='controlleurs/traitementCorrectionArticle.php'>"
	."<h1 class='utilisateurs'>Modification d'un article:</h1>"
	...
	."<td width='600px' class='utilisateurs'>"
	...
	."<input type='submit' name='save' value='Corriger l&apos;article' />"
