<?php
function AfficheFormExplicationSuppressionArticleEnValidation(){
	//--
	check_session();
	//--
	echo	"<table><tr><td width='600px' class='utilisateurs'>
	<h1 class='utilisateurs'>Raison(s) de la non-validation</h1>
	<form method='post' action='controlleurs/traitementSuppressionArticleEnValidation.php'>
