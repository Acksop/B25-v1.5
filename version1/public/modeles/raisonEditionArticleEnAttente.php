<?php
function AfficheFormExplicationEditionArticleEnAttente(){
	//--
	check_session();
	//--	
	...
	echo 	"<form method='post' action='controlleurs/traitementEditionArticleEnAttente.php'>"
	."<h1 class='utilisateurs'>&Eacute;dition de l&apos;article:</h1>"
	."<table><tr><td width='600px' class='utilisateurs'>"
	.'<p align="left">Titre: <input type="text" name="titre" size="80" value="'.$data['titre'].'"></p>'
	."<!-- Gets replaced with TinyMCE, remember HTML in a textarea should be encoded -->"
	."<textarea id='elm1' name='corps' rows='15' cols='80' style='width: 100%'>"
	...
	."<input type='submit' name='save' value='Envoyer l&apos;article &eacute;dit&eacute; &agrave; une nouvelle validation (avec Courriel)' />"
