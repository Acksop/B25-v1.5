...
."<h2 class='legende'>Personnalit&eacute;e de l'Artiste :</h2><br/>";
	
AfficherFormulaireDeTweet();

echo "<div class='conteneurGrandInterieur'>"
	."<h3 class='legende'>Propri&eacute;t&eacute;s de la page personnelle :<h3>";
...
echo "TYPE D'AFFICHAGE DE LA PAGE PERSONNELLE:</td>";
	...
	echo "</td><td class='utilisateurs'>"
		."<form name='modifInfoArtiste' method='post' action='controlleurs/traitementModifInfoArtiste.php'>"
		."<input type='hidden' name='affichage_tweets' value='".$artiste['affichage_tweets']."'/>"
		."<button type='submit' class='btn_modif'><img src='./images/picto-modifierCircle_up.gif' class='btn' onClick='submit();' onMouseOut='this.src=btn_modif_up;' onMouseDown='this.src=btn_modif_down;' onMouseOver='this.src=btn_modif_hover;' alt='Changer?' /></button>"
		."</form>";
