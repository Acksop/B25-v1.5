<?php
function AfficheFormCorrectionArticleEnValidation(){
	//--
	check_session();
	//--
	...
	echo "<form method='get' action='controlleurs/traitementCorrectionArticleEnValidation.php'>"
	...
	."<input type='submit' name='save' value='Tester la correction de l&apos;article' />"
