<?php
function AfficheFormCorrectionArticleEnAttente(){
	//--
	check_session();
	//--
	...
	echo "<form method='get' action='controlleurs/traitementCorrectionArticleEnAttente.php'>"
	."<h1 class='utilisateurs'>Correction d'un article:</h1>"
	...
	."<input type='submit' name='save' value='Tester la visualisation de l&apos;article ' />"
